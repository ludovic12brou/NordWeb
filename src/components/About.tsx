...
export default function About() {
  const team = [
    ...
    },
    {
      ...
      description: "Expert en développement technologique et solutions sur mesure."
    }
  ];
  ...
  return (
    <section id="about" className="py-24 bg-gradient-to-b from-slate-800 to-slate-900">
      <div className="container mx-auto px-4">
        <SectionTitle title="Notre Équipe" subtitle="Les visages derrière NordWeb" />
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-16">
          {team.map((member, index) => (
            <div key={index} className="group relative">
              <div className="relative overflow-hidden rounded-2xl aspect-[3/4] mb-6 shadow-xl mx-auto max-w-xs">
