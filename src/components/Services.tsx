...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description: "Boutiques en ligne performantes avec systèmes de paiement sécurisés et gestion simplifiée.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-8 h-8">
    ...
    {
      title: "Sécurité Web",
      description: "Protection avancée, certificats SSL, sauvegardes automatiques et surveillance 24/7.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-8 h-8">
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <div key={index} className="group relative bg-white/5 backdrop-blur-md p-8 rounded-2xl border border-white/5 hover:-translate-y-2 transition-all duration-300 hover:border-orange-500/50 hover:shadow-2xl overflow-hidden">
